 ...
 * generated in the cn.lcdiao package. 
...
public class ObjectFactory {
    ...
    private final static QName _Query_QNAME = new QName("http://lcdiao.cn/", "query");
    private final static QName _QueryResponse_QNAME = new QName("http://lcdiao.cn/", "queryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.lcdiao
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://lcdiao.cn/", name = "query")
     ...
     */
    @XmlElementDecl(namespace = "http://lcdiao.cn/", name = "queryResponse")
